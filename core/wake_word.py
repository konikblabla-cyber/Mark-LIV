"""
Local wake-word detection for JARVIS ("Hey Jarvis" or "Jarvis").
...
CPU. The pretrained wake model is "Hey Jarvis"; the detector also accepts a lower-confidence match so the model can react to the shorter "Jarvis" wake phrase.
"""
...
# Pretrained openwakeword model used for "Hey Jarvis" and the shorter "Jarvis" form.
...
class WakeWordDetector:
    ...
    def start(self) -> bool:
        ...
        self._thread.start()
        self._logger("Wake word: listening for 'Hey Jarvis' or 'Jarvis'.")
        return True
