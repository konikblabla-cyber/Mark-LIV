...
def windows_file_dialog(parameters=None, **kwargs):
    ...
    if action=="open": pyautogui.hotkey("ctrl","o")
    elif action=="save": pyautogui.hotkey("ctrl","shift","s")
    elif action=="folder": pyautogui.hotkey("win","e")
    else: return "Action must be open, save, or folder."
    time.sleep(.3)
