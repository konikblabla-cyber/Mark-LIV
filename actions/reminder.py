...
def _write_notify_script(task_name: str, message: str, os_name: str = "windows") -> Path:
    script_path = _scripts_dir() / f"{task_name}.py"
    msg_literal = json.dumps(message)
    notify_block = f"""\r
message = {msg_literal}\r
notified = False\r
try:\r
    from plyer import notification\r
    notification.notify(title="J.A.R.V.I.S Reminder", message=message, timeout=15)\r
    notified = True\r
except Exception:\r
    pass\r
if not notified:\r
    try:\r
        from win10toast import ToastNotifier\r
        ToastNotifier().show_toast("J.A.R.V.I.S Reminder", message, duration=15, threaded=False)\r
        notified = True\r
    except Exception:\r
        pass\r
if not notified:\r
    try:\r
        import subprocess\r
        subprocess.run(["msg", "*", "/TIME:30", message], check=False)\r
    except Exception:\r
        pass\r
try:\r
    import winsound\r
    for freq in (800, 1000, 1200):\r
        winsound.Beep(freq, 180)\r
        import time; time.sleep(0.08)\r
except Exception:\r
    pass\r
"""
    script_body = f"""# Auto-generated by J.A.R.V.I.S reminder — do not edit\r
{notify_block}\r
try:\r
    import pathlib\r
    pathlib.Path(__file__).unlink(missing_ok=True)\r
except Exception:\r
    pass\r
"""
