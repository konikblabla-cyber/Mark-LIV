...
"
        " import winsound
"
        " [winsound.Beep(f,180) for f in (800,1000,1200)]
"
...
<Principals><Principal id="Author"><LogonType>InteractiveToken</LogonType><RunLevel>LeastPrivilege</RunLevel></Principal></Principals>
    ...
    try:
        result = subprocess.run(["schtasks.exe","/Create","/TN",name,"/XML",str(xml),"/F"], capture_output=True, text=True, timeout=30, creationflags=subprocess.CREATE_NO_WINDOW)
    finally:
...
TOOL = {
    ...
    "parameters":{"type":"OBJECT","properties":{"seconds":{"type":"INTEGER","description":"Countdown duration in seconds."},"message":{"type":"STRING","description":"Notification text when the timer finishes."}},"required":["seconds"]},
    "handler":timer,
}
